...
import decorator.BasicAuthentication;
import decorator.InputValidationDecorator;
import decorator.LoggingAuthenticationDecorator;
...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        // Add ActionListener with Decorator Pattern
        login.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Create the authentication pipeline
                Authentication authentication = new BasicAuthentication();
                authentication = new InputValidationDecorator(authentication);
                authentication = new LoggingAuthenticationDecorator(authentication);

                // Perform authentication
                if (authentication.authenticate(username.getText(), new String(password.getPassword()))) {
